...
function FeaturedScreen({navigation}) {
  const [items, setItems] = React.useState([
    ...
    { name: 'HBO MAX', code: '#e74c3c', uri: 'https://dartdis.co/hbo-max', thumbnail: 'https://dart-discover.s3.amazonaws.com/thumbnails/HBO-MAX-cover.png' },
    ...
    { name: 'Plex', code: '#f39c12', uri: 'https://www.plex.tv/', thumbnail: 'https://dart-discover.s3.amazonaws.com/thumbnails/Plex-TV-cover.png' },
